...
if __name__ =="__main__": 
    ...
    finv_fp = r'C:\LS\03_TOOLS\CanFlood\_ins\prep\wsamp\cT1\finv_icomp_cT1.gpkg'
    
    #==========================================================================
    # initilize
    #==========================================================================
    wrkr =  WSLSampler(logger=logger, 
                       out_dir = r'C:\LS\03_TOOLS\CanFlood\_outs\wsamp',
                       tag='test')
    
    #set the coordinate system
    """I assume this will just be the project coordinate s ystem"""
    ...
    wrkr.run(raster_l, finv,
             control_fp = r'C:\LS\03_TOOLS\CanFlood\_ins\prep\wsamp\cT1\CanFlood_control_01.txt',
             )
